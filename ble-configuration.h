...
// Top level macros
#define SILABS_AF_DEVICE_NAME "soc-smartPhone2"
...
// Use this macro to check if GLIB plugin is included
#define SILABS_AF_PLUGIN_GLIB
...
// Use this macro to check if KIT_LCD plugin is included
#define SILABS_AF_PLUGIN_KIT_LCD
